            ...
            <div className="container mx-auto px-4 py-12">
                <div className="flex flex-col md:flex-row items-start gap-16">
                    ...
                    <div className="w-full md:w-1/2 md:pl-8">
                        <h1 className="text-[40px] font-bold text-black mb-2">Welcome to</h1>
                        ...
                        <div className="bg-gray-50 rounded-lg p-8 mb-12">
                            <h3 className="text-xl text-gray-800 mb-6">
                                Dive deeper with insights into key port service KPIs:
                            </h3>
                            <ul className="space-y-4">
                                <li className="flex items-center gap-3">
                                    ...
                                    <span className="text-gray-600">Vessel arrivals and berthings</span>
                                </li>
                                <li className="flex items-center gap-3">
                                    <svg className="w-5 h-5 text-[#10B981]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                    <span className="text-gray-600">Just-In-Time (JIT) performance</span>
                                </li>
                                <li className="flex items-center gap-3">
                                    <svg className="w-5 h-5 text-[#10B981]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                    <span className="text-gray-600">Wharf utilization rates</span>
                                </li>
                            </ul>
                        </div>
