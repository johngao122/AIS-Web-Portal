...
const MapWithSearchBar: React.FC<MapProps> = ({ 
  ...
  const vesselLayer = new IconLayer({
    ...
    getSize: d => 300,
    getColor: d => activeVessel?.mmsi === d.mmsi ? [128, 128, 0] : [52, 199, 89],
  ...
  const renderTooltip = () => {
    ...
    const getTooltipContent = () => {
      switch (layer) {
        ...
        case 'anchorage':
          return (
            <>
              <div className="font-semibold text-blue-600">Anchorage Area</div>
        ...
        case 'fairway':
          return (
            <>
              <div className="font-semibold text-orange-600">Fairway</div>
              <div>Name: {object.name || 'Unnamed'}</div>
        ...
        case 'lane':
          return (
            <>
              <div className="font-semibold text-red-600">Lane</div>
              <div>ID: {object.id}</div>
              <div>Type: {object.seamark_type}</div>
            </>
          );
        ...
        case 'mooringArea':
          return (
            <>
              <div className="font-semibold text-green-600">Mooring Area</div>
              <div>Name: {object.name || 'Unnamed'}</div>
              <div>Type: {object.seamark_type}</div>
            </>
          );
        ...
        case 'separation':
          return (
            <>
              <div className="font-semibold text-purple-600">Separation Zone</div>
              <div>ID: {object.id}</div>
              <div>Type: {object.seamark_type}</div>
            </>
          );
        ...
        case 'vessel':
          return (
            <>
              <div className="font-semibold text-yellow-600">Vessel</div>
    ...
    const getBorderColor = () => {
      switch (layer) {
        case 'anchorage': return '#2563eb';
        case 'fairway': return '#ea580c';
        case 'lane': return '#dc2626';
        case 'mooringArea': return '#16a34a';
        case 'separation': return '#7c3aed';
        case 'vessel': return '#ca8a04';
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <LayerToggle />
      <div className="absolute top-32 left-1/2 transform -translate-x-1/2 w-1/2">
        <SearchBar onSearch={() => {}} />
      </div>
    </div>
  );
